...
async function openReview(id) {
  ...
  panel.innerHTML = `
    ...
    <form id="reviewActionForm" class="page-stack">
      <div class="form-grid"><label>Reviewer<input id="reviewerId" value="${escapeHtml(state.user?.username || 'reviewer-ui')}" required /></label><label>Motivo<input id="reviewReason" value="Validado desde CAPTRE Console" required /></label></div>
